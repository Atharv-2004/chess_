...
Piece.prototype.moveTo = function (targetPosition) {
    ...
    this.position = targetPosition.row + targetPosition.col;
    // Re-render piece at new position
    this.render();
    console.log(this.color + " " + this.type + " moved to: " + this.position);
};
...
Piece.prototype.kill = function (targetPiece) {
    console.log("Method not implemented by: " + typeof this);
};
